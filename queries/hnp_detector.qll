...
import python
import python.dataflow
import python.dataflow.TaintTracking

class MyFlowConfiguration extends python.dataflow::Configuration {
  MyFlowConfiguration() { this = "MyFlowConfiguration" }
  
  override predicate isSource(python.dataflow::Node source) {
    any()
  }

  override predicate isSink(python.dataflow::Node sink) {
    any()
  }
}
