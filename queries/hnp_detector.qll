...
module MyFlowConfiguration implements python.dataflow::ConfigSig {
  predicate isSource(python.dataflow::Node source) {
    any()
  }

  predicate isSink(python.dataflow::Node sink) {
    any()
  }
}
